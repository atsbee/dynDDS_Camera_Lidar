...
int main()
{
    ...
    SpriteTexture logoStruct = {logo, logoTexture, "../images/TH_Koeln_Logo2.png", 2, (BREITEGRENZE -900), (HOEHENGRENZE -600)};
    getImage(logoStruct);
    //Sensor Image
    sf::Sprite lidarImage;
    sf::Texture lidarTexture;
    SpriteTexture lidarStruct = {lidarImage, lidarTexture, "../images/rplidar-a1m8-135.png", 0.5, -125, -125};
    getImage(lidarStruct);
    //Robot Image
    sf::Sprite roboImage;
    sf::Texture roboTexture;
    SpriteTexture roboStruct = {roboImage, roboTexture, "../images/sidearm_nomotor.png", 2, 120, -710};
    getImage(roboStruct);
    //Table and poles
    ...
    //Font for labels
    sf::Font font;
    if (!font.loadFromFile("../include/OpenSans.ttf"))
    {
