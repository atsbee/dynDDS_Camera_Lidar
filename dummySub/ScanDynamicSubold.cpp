            ...
            if (info.instance_state == ALIVE_INSTANCE_STATE)
            {
                ...
                for (auto pair : members)
                {
                    ...
                    case eprosima::fastrtps::types::TK_ARRAY:
                        ...
                        //eprosima::fastrtps::types::TypeDescriptor typeDescriptor = memberDesc->get_type()->get_descriptor();
...
void ScanDynamicSub::initialize_entities(std::string topic_name)
{
    ...
    std::cout << "Created reader with topic and name: "  << std::endl;
